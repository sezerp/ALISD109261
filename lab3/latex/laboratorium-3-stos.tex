...
\begin{python}[caption=push\_front() lista jedno kierunkowa]
...
\begin{python}[caption=push\_front() lista dwukierunkowa kierunkowa]
...
\begin{python}[caption=push\_back() lista jednokierunkowa kierunkowa]
...
\begin{python}[caption=push\_back() lista dwukierunkowa kierunkowa]
def push_back(xs: List[T], e: T):
    node = Node[T](e)
    xs.size += 1
    if xs.head is None:
...
\begin{python}[caption=pop\_front() lista jedno kierunkowa]
...
\begin{python}[caption=pop\_front() lista dwukierunkowa kierunkowa]
def pop_front(xs: List[T]):
    node = None
    if xs.is_empty():
        raise IndexError
...
\begin{python}[caption=pop\_back() lista jednokierunkowa kierunkowa]
...
\begin{python}[caption=pop\_back() lista dwukierunkowa kierunkowa]
def pop_back(xs: List[T]):
    node = None
    if xs.is_empty():
        raise IndexError
...
\begin{python}[caption=pop\_1() lista jedno kierunkowa]
